...
ROOT_DIR = environ.Path(__file__) - 3  # (genomics_geek/config/settings/base.py - 3 = genomics_geek/)
APPS_DIR = ROOT_DIR.path('genomics_geek')
...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres:///genomics_geek'),
}
...
MIGRATION_MODULES = {
    'sites': 'genomics_geek.contrib.sites.migrations'
}
...
# Celery
# ------------------------------------------------------------------------------
INSTALLED_APPS += ['genomics_geek.taskapp.celery.CeleryAppConfig']
if USE_TZ:
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = 'genomics_geek.users.adapters.AccountAdapter'
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = 'genomics_geek.users.adapters.SocialAccountAdapter'
